# LoanFix — Lender User Manual

A step-by-step guide for **lenders** (microfinance institutions, SACCOs, chamas,
and individual lenders) using LoanFix to run their lending business.

> **What is LoanFix?** A cloud loan-management system. You manage clients, loans,
...
1. Go to the LoanFix home page and click **Start Free Trial**.
2. Fill in:
   - **Business name** (e.g. *Faulu Microfinance*)
   - **Business type** — Microfinance, SACCO, Chama, or Individual Lender
   - **Your subdomain** (e.g. *faulu* → your space at `faulu.loanfix.co.ke`)
...
Your borrowers get a single LoanFix account that works across every lender they
...
**Need help?** Contact LoanFix support from the footer of the site.
