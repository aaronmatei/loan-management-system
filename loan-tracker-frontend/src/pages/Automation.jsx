    ...
    <div className="p-4 lg:p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 flex items-center gap-2">
          <Zap size={28} /> Automation
        </h1>
        <p className="text-gray-600 mt-1">
          Automatic reminders and overdue tracking for your borrowers.
        </p>
      </div>
      ...
      {/* Cadence settings */}
      <form onSubmit={saveSettings} className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">e.g. 3 = remind 3 days early.</p>
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg disabled:opacity-50"
          >
            <RotateCcw size={16} />
