...
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        role="alert"
        className="min-h-screen w-full flex items-center justify-center p-6 bg-slate-50"
      >
        <div className="max-w-md w-full bg-white border border-slate-200 rounded-2xl shadow-sm p-8 text-center">
          ...
          {isDev && this.state.error && (
            <details className="text-left mb-6 bg-slate-50 border border-slate-200 rounded-lg p-3">
