  ...
  return (
    <>
      ...
      <Card title="Receipts & Payments" note="Cash book of the savings pool">
        ...
        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mt-3 mb-1">Payments</p>
      ...
      <Card title="Income & Expenditure" note="A chama is mutual — surplus, not profit">
        ...
        <Row label="Less: dividends distributed" value={KES(-ie.dividends_appropriated)} indent tone="text-slate-500" />
      ...
      <Card title="Balance Sheet" note="Statement of affairs">
        ...
        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mt-3 mb-1">Members' funds</p>
