    ...
    <>
      ...
      {showSMS && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-surface rounded-xl shadow-2xl p-8 max-w-2xl w-full text-gray-800 dark:text-slate-100">
      ...
      {showEmail && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-surface rounded-xl shadow-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto text-gray-800 dark:text-slate-100">
